...
public class Meteor extends Agent {
    ...
    static {
        try {
            // Textures de base
            TEXTURES.put("cratere", ImageIO.read(new File("./ressources/sprite_meteore/cratere_meteor.png")));
            TEXTURES.put("cratere_night", ImageIO.read(new File("./ressources/sprite_meteore/cratere_meteor_night.png")));

            TEXTURES.put("meteorite", ImageIO.read(new File("./ressources/sprite_meteore/meteor_fall.png")));

            //fissure
            TEXTURES.put("fissure1", ImageIO.read(new File("./ressources/sprite_meteore/fissure1.png")));
            TEXTURES.put("fissure2", ImageIO.read(new File("./ressources/sprite_meteore/fissure2.png")));
    ...
    private static void loadExplosionFrames(String prefix, int frameCount) {
        for (int i = 1; i <= frameCount; i++) {
            String path = String.format("./ressources/ezgif-split/%s/Sprites/%s%d.png", 
