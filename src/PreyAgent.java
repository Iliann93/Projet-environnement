...
public class PreyAgent extends Agent {
    ...
    static {
        try {
            ...
            // Noir
            TEXTURES.put("noir_haut", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_noir/mouton_dos.png")));
            TEXTURES.put("noir_bas", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_noir/mouton_face.png")));
            TEXTURES.put("noir_droite", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_noir/mouton_gauche.png")));
            TEXTURES.put("noir_gauche", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_noir/mouton_droite.png")));

            // Blanc
            TEXTURES.put("blanc_haut", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite/mouton_dos.png")));
            TEXTURES.put("blanc_bas", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite/mouton_face.png")));
            TEXTURES.put("blanc_droite", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite/mouton_gauche.png")));
            TEXTURES.put("blanc_gauche", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite/mouton_droite.png")));

            // Gris
            TEXTURES.put("gris_haut", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_gris/mouton_dos.png")));
            TEXTURES.put("gris_bas", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_gris/mouton_face.png")));
            TEXTURES.put("gris_droite", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_gris/mouton_gauche.png")));
            TEXTURES.put("gris_gauche", ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_gris/mouton_droite.png")));

            // Night (commun à toutes les couleurs)
            TEXTURES.put("night_haut", ImageIO.read(new File("./ressources/sprite_gars_night/mouton_sprite_night/mouton_dos.png")));
            TEXTURES.put("night_bas", ImageIO.read(new File("./ressources/sprite_gars_night/mouton_sprite_night/mouton_face.png")));
            TEXTURES.put("night_droite", ImageIO.read(new File("./ressources/sprite_gars_night/mouton_sprite_night/mouton_gauche.png")));
            TEXTURES.put("night_gauche", ImageIO.read(new File("./ressources/sprite_gars_night/mouton_sprite_night/mouton_droite.png")));

            // Feu
            TEXTURES.put("feu", ImageIO.read(new File("./ressources/ezgif-split/fire/feu.png")));
            TEXTURES.put("feu1", ImageIO.read(new File("./ressources/ezgif-split/fire/feu1.png")));
            TEXTURES.put("feu2", ImageIO.read(new File("./ressources/ezgif-split/fire/feu2.png")));
            TEXTURES.put("feu3", ImageIO.read(new File("./ressources/ezgif-split/fire/feu2.png")));
	...
	public void change_color(int probs){
		...
		try{	
			if(noir == true){
				haut = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_noir/mouton_dos.png"));
				bas = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_noir/mouton_face.png"));
				droite = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_noir/mouton_gauche.png"));
				gauche= ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_noir/mouton_droite.png"));
			}else if(blanc == true){
				haut = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite/mouton_dos.png"));
				bas = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite/mouton_face.png"));
				droite = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite/mouton_gauche.png"));
				gauche= ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite/mouton_droite.png"));
			}else{
				haut = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_gris/mouton_dos.png"));
				bas = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_gris/mouton_face.png"));
				droite = ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_gris/mouton_gauche.png"));
				gauche= ImageIO.read(new File("./ressources/sprite_gars/mouton_sprite_gris/mouton_droite.png"));
			}
		

				haut_night = ImageIO.read(new File("./ressources/sprite_gars_night/mouton_sprite_night/mouton_dos.png"));
				bas_night = ImageIO.read(new File("./ressources/sprite_gars_night/mouton_sprite_night/mouton_face.png"));
				droite_night = ImageIO.read(new File("./ressources/sprite_gars_night/mouton_sprite_night/mouton_gauche.png"));
				gauche_night = ImageIO.read(new File("./ressources/sprite_gars_night/mouton_sprite_night/mouton_droite.png"));
