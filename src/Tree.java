...
public class Tree extends Agent {
    ...
    static {
        try {
            ...
            TEXTURES.put("tree", ImageIO.read(new File("./ressources/tree_sprite/tree4.png")));
            TEXTURES.put("tree1", ImageIO.read(new File("./ressources/tree_sprite/tree5.png")));
            TEXTURES.put("tree2", ImageIO.read(new File("./ressources/tree_sprite/tree6.png")));
            TEXTURES.put("tree3", ImageIO.read(new File("./ressources/tree_sprite/tree7.png")));
            TEXTURES.put("tree4", ImageIO.read(new File("./ressources/tree_sprite/tree8.png")));
            TEXTURES.put("tree_night", ImageIO.read(new File("./ressources/tree_sprite/tree10.png")));
            
            TEXTURES.put("thunder1", ImageIO.read(new File("./ressources/sprite_thunder/map2.png")));
            TEXTURES.put("thunder2", ImageIO.read(new File("./ressources/sprite_thunder/map3.png")));
            TEXTURES.put("thunder3", ImageIO.read(new File("./ressources/sprite_thunder/map4.png")));
            TEXTURES.put("thunder4", ImageIO.read(new File("./ressources/sprite_thunder/map5.png")));
