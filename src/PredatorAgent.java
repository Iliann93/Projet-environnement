...
public class PredatorAgent extends Agent {
    ...
    static {
        try {
            // Normal
            TEXTURES.put("haut", ImageIO.read(new File("./ressources/sprite_gars/agent1.png")));
            TEXTURES.put("bas", ImageIO.read(new File("./ressources/sprite_gars/agent.png")));
            TEXTURES.put("droite", ImageIO.read(new File("./ressources/sprite_gars/agent2.png")));
            TEXTURES.put("gauche", ImageIO.read(new File("./ressources/sprite_gars/agent3.png")));

            // Night
            TEXTURES.put("haut_night", ImageIO.read(new File("./ressources/sprite_gars_night/agent1.png")));
            TEXTURES.put("bas_night", ImageIO.read(new File("./ressources/sprite_gars_night/agent.png")));
            TEXTURES.put("droite_night", ImageIO.read(new File("./ressources/sprite_gars_night/agent2.png")));
            TEXTURES.put("gauche_night", ImageIO.read(new File("./ressources/sprite_gars_night/agent3.png")));

            // Malade
            TEXTURES.put("haut_malade", ImageIO.read(new File("./ressources/sprite_gars/sprite_gars_malade/agent1.png")));
            TEXTURES.put("bas_malade", ImageIO.read(new File("./ressources/sprite_gars/sprite_gars_malade/agent.png")));
            TEXTURES.put("droite_malade", ImageIO.read(new File("./ressources/sprite_gars/sprite_gars_malade/agent2.png")));
            TEXTURES.put("gauche_malade", ImageIO.read(new File("./ressources/sprite_gars/sprite_gars_malade/agent3.png")));

            // Malade Night
            TEXTURES.put("haut_malade_night", ImageIO.read(new File("./ressources/sprite_gars_night/sprite_malade_night/agent1.png")));
            TEXTURES.put("bas_malade_night", ImageIO.read(new File("./ressources/sprite_gars_night/sprite_malade_night/agent.png")));
            TEXTURES.put("droite_malade_night", ImageIO.read(new File("./ressources/sprite_gars_night/sprite_malade_night/agent2.png")));
            TEXTURES.put("gauche_malade_night", ImageIO.read(new File("./ressources/sprite_gars_night/sprite_malade_night/agent3.png")));

            // Muter
            TEXTURES.put("haut_muter", ImageIO.read(new File("./ressources/sprite_gars_muter/agent1.png")));
            TEXTURES.put("bas_muter", ImageIO.read(new File("./ressources/sprite_gars_muter/agent.png")));
            TEXTURES.put("droite_muter", ImageIO.read(new File("./ressources/sprite_gars_muter/agent2.png")));
            TEXTURES.put("gauche_muter", ImageIO.read(new File("./ressources/sprite_gars_muter/agent3.png")));

            // Muter Night
            TEXTURES.put("haut_night_muter", ImageIO.read(new File("./ressources/sprite_gars_muter/night/agent1.png")));
            TEXTURES.put("bas_night_muter", ImageIO.read(new File("./ressources/sprite_gars_muter/night/agent.png")));
            TEXTURES.put("droite_night_muter", ImageIO.read(new File("./ressources/sprite_gars_muter/night/agent2.png")));
            TEXTURES.put("gauche_night_muter", ImageIO.read(new File("./ressources/sprite_gars_muter/night/agent3.png")));
