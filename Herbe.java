...
public class Herbe extends Agent {
    ...
    static {
        try {
            // Textures normales
            TEXTURES.put("herbe", ImageIO.read(new File("./sprite_herbe/herbe.png")));
            TEXTURES.put("herbe1", ImageIO.read(new File("./sprite_herbe/herbe1.png")));
            TEXTURES.put("herbe2", ImageIO.read(new File("./sprite_herbe/herbe2.png")));
            TEXTURES.put("herbe3", ImageIO.read(new File("./sprite_herbe/herbe_seche.png")));

            // Textures nuit
            TEXTURES.put("herbe_night", ImageIO.read(new File("./sprite_herbe/herbe_night.png")));
            TEXTURES.put("herbe1_night", ImageIO.read(new File("./sprite_herbe/herbe1_night.png")));
            TEXTURES.put("herbe2_night", ImageIO.read(new File("./sprite_herbe/herbe2_night.png")));
            TEXTURES.put("herbe3_night", ImageIO.read(new File("./sprite_herbe/herbe_seche_night.png")));
